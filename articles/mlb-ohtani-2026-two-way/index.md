...
subtitle: "2024 年整季沒投一球，2026 年他以 13 場先發、8 勝 2 敗、防禦率 1.58、86 次三振重返投手丘——這個 ERA 已是全聯盟先發頂尖（局數略放寬僅次於一位新秀；目前投球局數還差約一局才達正式 ERA 王門檻）。但他同時是道奇打線強棒，77 場打擊交出 .295/.414/.549。誠實說：精力分給投球，全壘打節奏（17 轟）明顯低於 2024 那個「只打擊的大谷」所打出的 54 轟。賽季過半，這是大谷翔平二刀流完整運轉後，第一份真實的成績單。"
lede: "截至 2026-06-25，大谷翔平（Shohei Ohtani）以 13 場先發投出防禦率 1.58、WHIP 0.90、86 次三振（9 局平均 9.72K），ERA 1.58 在全聯盟先發投手裡屬於頂尖——若把投球局數門檻略放寬，僅次於新秀米斯歐羅斯基（Jacob Misiorowski）的 1.45；唯目前 79.2 局尚差約一局才達正式 ERA 王的規定局數，因此暫未列入官方合格排行榜。打擊端 77 場 .295 打擊率、OPS .963，但全壘打僅 17 支，節奏遠低於 2024 的 54 轟。這是他術後第一個投打並行的完整賽季——過半數據告訴我們，他在投球上極度宰制，但兩條線都跑就意味著打擊火力要做出取捨。"
---
...
那麼，ERA 1.58 放在全聯盟的先發投手裡，位置是什麼？（下表為先發投手 ERA 對照，把局數門檻略放寬以納入大谷——詳見表後說明）

| 2026 先發投手 ERA 對照（截至 6/25）| 排名 | 投手 | ERA |
| :---- | :----: | :---- | :----: |
...
以這個略放寬局數門檻的對照來看，大谷的 1.58 在先發群裡僅次於米斯歐羅斯基——後者是一位新秀投手，ERA 1.45。但這裡必須誠實補上一個關鍵脈絡，否則就是把數字講過頭了：**大谷目前 79.2 局，還差約一局才達到正式 ERA 王的規定局數**（門檻是「球隊每出賽一場、投手須累積一局」，道奇此時已打約 81 場）。也就是說，在 MLB 官方的合格 ERA 排行榜上，現階段其實還看不到大谷的名字——上表是把門檻略往下放、才得以把他和其他合格投手並列比較的結果。所以最精確的說法不是「全聯盟排名第二」，而是：**他的 ERA 1.58 已是全聯盟先發數一數二低的水準，只待局數補足就會正式列入榜單。** 這篇文章不打算把他說成「全聯盟最強投手」，因為數字沒有這樣說；但「頂尖、僅次於米斯歐羅斯基」這個描述是真實的，而且必須加上一個脈絡：**對照表上其他所有投手，都不需要在非投球日坐進打擊區擔任先發。** 他們只需要專注於投球、為下一次登板做準備，而大谷同時還在打擊端每天出現。這個差異不能忽略。
...
ERA 1.58、WHIP 0.90、K/9 為 9.72，在全聯盟先發投手裡數一數二——這些不是「還不錯」的數字，而是「聯盟前段」的數字。他在 13 場先發裡拿到 8 場勝投，只有 2 敗，勝率達到 0.8，這個比值在先發投手裡屬於高勝率。對一個剛從手肘手術完全恢復、同時還兼顧打擊的球員來說，這樣的投球成績是超出保守預期的。
...
2026 年過半的答案是：他可以同時以全聯盟數一數二低的 ERA 主宰投手丘，並在打擊端維持 OPS 將近 1.000 的水準——只是全壘打的部分，必須為此讓路。這個版本的大谷，比「只打擊」時的長打少，但比任何一個只有投球或只有打擊的球員，都多了一整個維度。
